...
同一个harness、同样的prompt、同样的工具，7个最新模型跑2个最难的编码任务：

| 模型 | 重构 | Bug修复 | 得分 | Token |
|------|:----:|:------:|:----:|------:|
| **GPT-5.4** | **✓ 7轮** | **✓ 6轮** | **2/2** | 58K |
| **Claude Sonnet 4.6** | **✓ 10轮** | **✓ 14轮** | **2/2** | 51K |
| **GPT-5.4-mini** | **✓ 10轮** | **✓ 8轮** | **2/2** | 96K |
| Claude Opus 4.6 | ✗ | ✓ 12轮 | 1/2 | 75K |
| GPT-5.3-codex | ✗ | ✓ 7轮 | 1/2 | 91K |
| Gemini-3-Flash | ✗ | ✗ | 0/2 | 143K |
| Gemini-3-Pro | ✗ | ✗ | 0/2 | 71K |

**GPT-5.4速度最快**（总共13轮）。**Claude Sonnet最省钱**（51K tokens）。**Gemini 3两个都做不了。** Opus居然不如Sonnet——更贵≠更好。

同样的2个任务在DeepSeek-V3.2上跑了0/9。**模型选择的影响是harness优化的10倍。**
